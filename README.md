...
| ------------------------------------------------------------------------------------- | ------- | ---------------------- | --------------------------------------------------------------------- |
| [AirportItlwm](https://github.com/OpenIntelWireless/itlwm)                            | v2.1.0  | Nov 2 2021 Alpha      | Intel Wi-Fi Adapter Kext for macOS                                    |
| [AppleALC](https://github.com/acidanthera/AppleALC)                                   | v1.6.7  | Dec 6 2021 Release    | Native macOS HD audio for not officially supported codecs             |
...
| [Lilu](https://github.com/acidanthera/Lilu)                                           | v1.5.8  | Dec 6 2021 Release    | Arbitrary kext and process patching on macOS                          |
...
| [WhateverGreen](https://github.com/acidanthera/WhateverGreen)                         | v1.5.5  | Nov 1 2021 Release    | Various patches necessary for certain ATI/AMD/Intel/Nvidia GPUs       |

## OpenCore
- OpenCore v0.7.6 Release on Dec 6 2021
